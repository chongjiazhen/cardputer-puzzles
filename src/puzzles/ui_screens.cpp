...
// ---------------- command menu ----------------
static const char* kCmdItems[]   = {"Size / Type","New game","Restart","Solve","Undo","Redo","Pointer","Recenter","Zoom 2x","Pan (zoom)","Rules"};
static const char* kCmdSuffix[]  = {"",           "Ctrl+N",  "Ctrl+R", "",     "Ctrl+Z","Ctrl+Y","Ctrl+P","Ctrl+Sp", "Ctrl+L", "C+;,./",    ""};
static const int   kCmdN = 11;
  ...
  switch (ev.kind) {
    ...
    case Ev::Select:
      switch (g_cmdSel) {
        ...
        case 7: g_ui.recenter(); g_ui.resume(); break;
        case 8: g_ui.toggleZoom(); g_ui.resume(); break;
        case 9: g_ui.resume(); break;   // Pan is a reference entry: panning is Ctrl+;,./ while zoomed
        case 10: g_ui.resume(); openRules(); break;
      }
      break;
    default: break;
  }
